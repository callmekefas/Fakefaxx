...
<body>
    ...
    <section class="home" id="home">
        <img src="img/navbar1.png" alt="Banner Image" />
        <div class="home-text container">
            <h1>Welcome to FakeFact</h1>
            <p>
    ...
    <footer>
        <div class="footer-container">
            <div class="sec aboutus">
                <h2>About Us</h2>
                <p>
                    FakeFact adalah sebuah web yang di rancang oleh tiga pemuda hebat, tampan, pemberani, rajin menabung, tidak sombong, dan bermartabat.
                    jika tertarik dengan kami, silahkan <a href="static/about.php">klik disini</a>.
                </p>
                <ul class="sci">
                    <li>
                        <img src="img/kefas.png" alt="">
                    </li>
                    <li>
                        <img src="img/arvin.png" alt="">
                    </li>
                    <li>
                        <img src="img/fahril1.png" alt="">
                    </li>
                    <li>
                        <img src="img/forlan.png" alt="">
                    </li>
                </ul>
            </div>
            ...
            <div class="sec contactBx">
                ...
                <ul class="info">
                    ...
                    <li>
                        ...
                        <p>
                            <a href="mailto:fakefact0090@gmail.com">fakefact0090@gmail.com</a>
                        </p>
                    </li>
                </ul>
            </div>
